  ...
  <div class="container mx-auto px-4 py-3">
    <div class="flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center space-x-8">
        ...
        <x-nav-link href="{{ route('news.news') }}" :active="request()->routeIs('news.news')" class="text-gray-800 hover:text-primary">Tin tức</x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="md:hidden mt-3">
      ...
      <x-responsive-nav-link href="{{ route('news.news') }}" :active="request()->routeIs('news.news')">Tin tức</x-responsive-nav-link>
