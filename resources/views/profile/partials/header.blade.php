  ...
  <div class="container mx-auto px-4 py-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        <button id="loginBtn" class="text-gray-800 hover:text-primary transition font-medium">Đăng nhập</button>
        <button id="registerBtn" class="bg-primary text-white py-2 px-4 rounded-button hover:bg-opacity-90 transition whitespace-nowrap">Đăng ký</button>
